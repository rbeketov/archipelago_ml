...
class SystemPromts(StrEnum):
    SUMMARAIZE = "Выдели основные мысли из диалога. Добавляй в конец каждой фразы йо-хо-хо. Вставляй пиратские высказывания по типу \'Черт побери\' в случайные места."
