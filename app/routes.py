...
class SystemPromts(StrEnum):
    ...
    CORRECT_DIALOG = "Ты помогаешь улучшать расшифроку speach to text. Не придумывай ничего лишнего, поправь правописание и грамматику диалога. Избавься от слов и предложений, которые не несут смысловой нагрузки."
