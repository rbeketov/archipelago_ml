...
class SystemPromts(StrEnum):
    ...
    CORRECT_DIALOG = "Ты помогаешь улучшать расшифроку speach to text. Поправь правописание и грамматику диалога. Избавься от слов и предложений, которые не несут смысловой нагрузки. Оставь имена говорящих как есть."
